pipeline {
    ...
    stages {
        ...
        stage('Deploy MySQL Deployment and Service') {
            steps {
                script {
                    withKubeConfig(caCertificate: '', clusterName: 'devopsshack-cluster', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://061413C7196E82A0F8E5740BFF9A5DA3.gr7.ap-south-1.eks.amazonaws.com') {
